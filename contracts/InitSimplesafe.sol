...
contract InitSimplesafe {
    ...
    function initialization(address newOwner) payable public{
        // prevent owner from modifying 
        require(!isOwnerinit,"Owner can only be changed once.");
